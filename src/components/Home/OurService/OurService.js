...
const serviceList = [
    {
        title: 'Supply & Commission of Industrial Machinery',
    ...
    {
        title: 'Spare parts of Industrial Machinery',
    ...
    {
        title: 'After sales service of Industrial Machinery  ',
...
const OurService = () => {
    ...
    return (
        <section className="my-5 py-5" id="service">
